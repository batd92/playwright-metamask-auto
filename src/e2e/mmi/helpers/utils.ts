...
const SLEEP_TIME = parseInt(process.env?.SLEEP_TIME || '1000');
...
export async function sleep(milliseconds: number = SLEEP_TIME): Promise<void> {
    return new Promise(resolve => setTimeout(resolve, milliseconds));
}

export const getSecond = (): number => {
